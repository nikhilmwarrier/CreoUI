...
public class SimpleHTTPClientUI extends JFrame {
    ...
    private void showSummaryDialog() {
        JDialog dialog = new JDialog(this, "AI Summary", true);
    ...
    private void onSendRequest() {
        ...
        SwingWorker<HttpResponse, Void> worker = new SwingWorker<>() {
            ...
            protected HttpResponse doInBackground() {
                ...
                return service.handleRequest(urlField.getText(),
            ...
            SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
                ...
                protected Boolean doInBackground() {
                    try {
                        ...
                        new RequestsDAO().Delete(selectedRequest.getID());
                        // Also delete associated response
                        new ResponsesDAO().DeleteByRequestID(selectedRequest.getID());
                        return true;
                    } catch (Exception e) {
                        e.printStackTrace();
                        return false;
    ...
    private void clearAllHistory() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
                ...
                protected Boolean doInBackground() {
                    try {
                        new RequestsDAO().DeleteAll();
                        new ResponsesDAO().DeleteAll();
                        return true;
                    } catch (Exception e) {
                        e.printStackTrace();
                        return false;
